...
namespace InventoryBeginners.Controllers
{
    ...
    public class PurchaseOrderController : Controller
    {
        ...
        //public IActionResult UpdateRecord(string mainid, string usersel)
        //{
        //    PoHeader item = new PoHeader();
        //    //item.Status = usersel;
        ...
        //    PaginatedList<Supplier> status = _StatusRepo.GetStatus("Name", SortOrder.Ascending, "", 1, 1000);

        //    lstStatus = status.Select(sp => new SelectListItem()
        //    {
        //        Value = sp.Id.ToString(),
        //        Text = sp.Name
        //    }).ToList();
